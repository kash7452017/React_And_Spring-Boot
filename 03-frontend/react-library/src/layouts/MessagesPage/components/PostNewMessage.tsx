...
export const PostNewMessage = () => {
    ...
    const [displaySuccess, setDiaplaySuccess] = useState(false);
    ...
    async function submitNewQuestion() {
        ...
        if (authState?.isAuthenticated && title !== "" && question !== "") {
            ...
            const submitNewQuestionResponse = await fetch(url, requestsOptions);
            ...
            setDiaplaySuccess(true);
        } else {
            setDisplayWaring(true);
            setDiaplaySuccess(false);
        }
    }
