...
> The homepage display includes the homepage link in the navigation bar at the top of the page, book inquiry, problem feedback, user borrowing records, payment page, and administrator function interface.
>
>Except for the return to homepage and book search functions, other functions require login verification before they can be opened and displayed.
>
>A carousel mode has been added to the homepage content, allowing users to quickly view book items. Clicking `Reserve` below a specific book will jump to the specified book introduction page.
>Add a simple introduction and quick guidance function for common needs at the bottom of the screen
